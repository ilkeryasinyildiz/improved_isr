...
StateWithMismatchCounter* StateWithMismatchCounter::clone() const
{
    ...
    state->setSuggestedValueCount(m_suggestedValueCount);//NEW!
...
Real StateWithMismatchCounter::getSuggestedValueCount() const
{
    return m_suggestedValueCount;
}

void StateWithMismatchCounter::setSuggestedValueCount(const Real &suggestedValueCount)
{
    m_suggestedValueCount = suggestedValueCount;
}

void StateWithMismatchCounter::incrementSuggestedValueCount()
{
    m_suggestedValueCount++;
}

#if defined(SIEVE_MODE)
PosInt StateWithMismatchCounter::getStoredClock() const
{
    return m_storedClock;
}

void StateWithMismatchCounter::setStoredClock(const PosInt &storedClock)
{
    m_storedClock = storedClock;
}
#endif
