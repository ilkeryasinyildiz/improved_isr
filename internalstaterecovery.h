...
private:
    ...
    static bool check_and_guess(StateWithMismatchCounter *state, QVector<StateWithMismatchCounter *> &NEW, const Real &alpha_threshold, const Bit& currentOutput, const Bit& actualOutput);
