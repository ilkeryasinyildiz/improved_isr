...
public:
    ...
    static Real calculateAverageGC(const LinearFeedbackShiftRegister & p_lfsr, const KeyRegister& p_key, PosInt &p_numOfCalculations);
    ...
    //NEW!
    static Real calculateSpeedFactor( const PosInt& numOfPossibleStates, const PosInt& numOfGCAboveOneHalf, const PosInt& lfsrSize);
